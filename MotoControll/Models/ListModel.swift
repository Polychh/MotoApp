...
var themes2: [ListModel] = [ListModel(id: 0, theme: "FAQ"),ListModel(id: 1, theme: "Разминка на мотоцикле"), ListModel(id: 2, theme: "Мотоэкипировка"),ListModel(id: 3, theme: "Как ездить в первый сезон"),ListModel(id: 4, theme: "Опасен ли мотоцикл?"), ListModel(id: 5, theme: "Литр на мотоцикле")]
